    ...
    $http.get('./data/results.json').success(function(students) {
      ...
      var getRating = function(student) {
          ...
          stat = function(student_ta_test_case) {
              ...
              return Math.log2(student_test_case.avg_memory / 
	                       ta_test_case.avg_memory + 1)
               + Math.log2(student_test_case.runtime / 
	                   ta_test_case.runtime + 1)
               + Math.log2(student_test_case.max_memory / 
	                   ta_test_case.max_memory + 1);
          }
          function add(a, b) {
              return a + b;
          }
